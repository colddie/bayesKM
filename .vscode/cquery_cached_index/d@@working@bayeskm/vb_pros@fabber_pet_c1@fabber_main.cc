...
// It is also possible to build Fabber models into a shared library which can be
//  loaded dynamically by any Fabber executable. We will not do that in this example
//   but if you’re interested look at the additional source files exp_models.cc and exp_models.h for details.