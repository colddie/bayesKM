...
optim::gd_basic_int(arma::vec& init_out_vals, std::function<double (const arma::vec& vals_inp, arma::vec* grad_out, void* opt_data)> opt_objfn, void* opt_data, algo_settings_t* settings_inp)
{
    ...
    double obj_val = box_objfn(x,&grad,opt_data);
    ...
    {
        std::cout << "\nGradient descent: beginning search...\n";
        std::cout << "  - Initialization Phase:\n";
        arma::cout << "    Objective function value:\n" << obj_val << "\n";
        arma::cout << "    Inferred Parameters:\n" << x_p << "\n";
    }
    ...
    while (err > err_tol && iter < iter_max)
    {
        ...
        double obj_val = box_objfn(x_p,&grad_p,opt_data);
        ...
        if (verbose_print_level > 0 and iter % 100 == 0)
        {
            std::cout << "  - Iteration: " << iter << "\n";
            arma::cout << "    Objective function value:" << obj_val << "\n";
            arma::cout << "    Inferred Parameters:" << x_p << "\n";
        }
    }
